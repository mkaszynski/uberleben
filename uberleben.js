...
let collide = {0: 0, 1: 0.4, 4: 0.7, 47: 0, 55: 0, 57: 0.5, 60: -0.3, 61: -0.3}
...
crafts.push([[[STICKS, STICKS, 0], [STICKS, STICKS, 0], [0, 0, 0]], [[FLOOR, 0, 0], [FLOOR, 0, 0], [0, 0, 0]], 50]);
crafts.push([[[STONE, 0, 0], [STONE, 0, 0], [0, 0, 0]], [[STONE_BRICKS, 0, 0], [0, 0, 0], [0, 0, 0]], 50]);
crafts.push([[[STONE_BRICKS, 0, 0], [STONE_BRICKS, 0, 0], [0, 0, 0]], [[STONE_PATH, STONE_PATH, 0], [STONE_PATH, STONE_PATH, 0], [0, 0, 0]], 50]);
...
function loop() {
  ...
  if (stage == "menue") {
    ...
    ctx.fillText("Version 1.1.2", 20, 50);
