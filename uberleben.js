...
let collide = {0: 0, 1: 0.4, 4: 0.7, 47: 0, 55: 0, 57: 0.5}
...
crafts.push([[[PLANKS, 0, 0], [PLANKS, PLANKS, 0], [0, 0, 0]], [[DOOR, 0, 0], [0, 0, 0], [0, 0, 0]], 100]);
...
function loop() {
  ...
  if (stage == "menue") {
    ...
    ctx.fillText("Version 0.11.5", 20, 50);
